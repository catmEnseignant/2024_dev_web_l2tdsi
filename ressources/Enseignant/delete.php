            ...
            <div class="bg-white divBreakClass3">
                <nav aria-label="breadcrumb" class="divBreakClass4">
                    <ol class="breadcrumb divBreakClass5">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Formulaire de Suppression</li>
                    </ol>
                </nav>
                <div>
                    <div class="center row bg-light divAdmin">
                        <div class=""><strong>Formulaire de suppression des données d'un enseignant</strong></div>
                    </div>
                </div>
                <div class="center row container">
                    <form action="Ens_Controller.php?action=del" method="post">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="exampleInputEmail1 mb-2">Matricule</label>
                                <input type="text" class="form-control" name="matricule" id="exampleInputEmail1" placeholder="146709">
                            </div>
                            <div class="form-group col-md-6">
