            ...
            <div class="bg-white divBreakClass3">
                <nav aria-label="breadcrumb" class="divBreakClass4">
                    <ol class="breadcrumb divBreakClass5">
                        ...
                        <li class="breadcrumb-item divBreakClass6"><a href="#">Enseignqnt</a></li>
                ...
                <div class="center row container">
                    <form action="Ens_Controller.php?action=store" method="post">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="phone" placeholder="787133864">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-6">
