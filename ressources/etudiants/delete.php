            ...
            <div class="bg-white divBreakClass3">
                <nav aria-label="breadcrumb" class="divBreakClass4">
                    <ol class="breadcrumb divBreakClass5">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Suppression</li>
                    </ol>
                </nav>
                <div>
                    <div class="center row bg-light divAdmin">
                        <div class=""><strong>Formulaire de suppression des données d'un étudiant</strong></div>
                    </div>
                </div>
                <div class="center row container">
                    <form action="EtudiantController.php?action=del" method="post">
                        <div class="row">
