            ...
            <div class="bg-white divBreakClass3">
                ...
                <div>
                    <div class="center row bg-light divAdmin">
                        ...
                        <div class="col-4"><strong>Nombre d'étudiants : <?php echo compter(); ?> </strong></div>
                        </div>
                    <div class="center row bg-light divAdmin">
                        <div class="col-4"><a href="EtudiantController.php?action=create" class="btn btn-outline-primary me-3"><span class="p-2">Ajouter</span></a></div>
                        <div class="col-4"><a href="EtudiantController.php?action=update" class="btn btn-outline-primary me-3"><span class="p-2">Modifier</span></a></div>
                        <div class="col-4"><a href="EtudiantController.php?action=delete" class="btn btn-outline-primary me-3"><span class="p-2">Suprimer</span></a></div>
                    </div>
                </div>
                <table class="table">
                    <thead>
