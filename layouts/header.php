...
// Cette Requête sert a compter les enregistrements
...
<div class="bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <div class="">
                            <ul class="navbar-nav lienNav ulClass1">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link ul_a_Class1"
                                        href="../etudiants/EtudiantController.php?action=index">Étudiants</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link ul_a_Class1" href="#">Examen</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link ul_a_Class1" href="#">Enseignant</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div>
        <div class="row text-center shadow bg-light divClassB">
            <div class="col-3 shadow-lg divClass3" id="divClass3">Etudiants<br><strong
                    class="text-dark"><?php echo $nbres['total'] ?></strong>
            </div>
            <div class="text-center col-lg-3 shadow-lg rounded divClass4">Examens<br><strong class="text-dark">2
                    <?php // echo $nbres['total'] 
                    ?>
                </strong>
            </div>
            <div class="text-center col-lg-3 shadow-lg rounded divClass5">Enseigants<br><strong class="text-dark">5
                    <?php // echo $nbres['total'] 
                    ?>
                </strong>
            </div>
